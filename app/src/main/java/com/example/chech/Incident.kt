...
import com.example.chech.Constants.Companion.MINIMUM_SENIORITY_FREE_RETARDANT
import com.example.chech.Constants.Companion.NUMBER_OF_RETARDANT_EQUIVALENT_TO_ONE_ABSENCE
import com.example.checkinout.hasPermission
...
data class Incident (val employee: Employee,
    ...
    @RequiresApi(Build.VERSION_CODES.O)
     fun getExpectedChecks(): List<CheckInOut>{
